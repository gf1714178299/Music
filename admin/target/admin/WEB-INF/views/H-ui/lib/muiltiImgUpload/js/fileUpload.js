...
var uploadTools = {
    ...
    "initWithUpload":function(opt){
        ...
        if(!opt.isHiddenUploadBt){
            ...
            $("#"+uploadId+" .uploadBts .uploadFileBt i").css({"color":"#2185D0","margin-top":"10px"});
        }
    ...
    "initWithCleanFile":function(opt){
        ...
        if(!opt.isHiddenCleanBt){
            ...
            $("#"+uploadId+" .uploadBts .cleanFileBt i").css({"color":"#2185D0","margin-top":"10px"});
        }
    },
    /**
     * 初始化选择文件按钮
    ...
    "initWithLayout":function(opt){
        ...
        btsStr += "<p style='color:red;'>(备注:图片按'东'->'南'->'西'->'北'方向依次进行上传)<p>";
